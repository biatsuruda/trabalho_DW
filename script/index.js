...
async function cadastroUsuario() {
  ...
  if (data.token) {
    ...
    // Lidar com cenário em que o token não é retornado
    console.error('Token não recebido após cadastro')
    return
  }
...
// Adicione essa linha para chamar a função validarbirthday() quando a página carregar
document.addEventListener('DOMContentLoaded', validarbirthday);
